...
def random_tableau_fichier(ligne = 8, colonne = 5, nom_fichier = 'levels/random.txt'):
	f = open(nom_fichier,'w')
	nom_tuile = ['chiffre', 'a', 'b', 'd', 'f', 'v']
	type = nom_tuile[randint(0,5)]
	for l in range(1,ligne):
		if type == nom_tuile[0]:
			f.write((str)(randint(1,9)))
		elif type == nom_tuile[1]:
			f.write('a' + (str)(randint(1,9))
		elif type == nom_tuile[2]:
			f.write('b' + (str)(randint(1,9))
		elif type == nom_tuile[3]:
			f.write('d' + (str)(randint(1,3))
		elif type == nom_tuile[4]:
			f.write('f' + (str)(randint(1,8))
		elif type == nom_tuile[5]:
			f.write('v' + (str)(randint(1,4))
		
	f.close()

random_tableau_fichier()
