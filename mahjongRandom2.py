...
def creer_level(level = 0):
	if level == 0:
		random_tableau_fichier(6,2,"levels\0.txt")
	elif level == 1:
		random_tableau_fichier(8,3,"levels\1.txt")
	elif level == 2:
		random_tableau_fichier(6,4,"levels\2.txt")
	elif level == 3:
		random_tableau_fichier(8,5,"levels\3.txt")
	elif level == 4:
		random_tableau_fichier(6,6,"levels\4.txt")
	elif level == 5:
		random_tableau_fichier(8,7,"levels\5.txt")
	elif level == 6:
		random_tableau_fichier(6,8,"levels\6.txt")
	elif level == 7:
		random_tableau_fichier(10,8,"levels\7.txt")
	elif level == 8:
		random_tableau_fichier(10,9,"levels\8.txt")
	elif level == 9:
		random_tableau_fichier(10,10,"levels\9.txt")
